...
{
    /// <inheritdoc />
    public partial class AddWeek5JobChatAudit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompletionEvidences_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobTimelines_AspNetUsers_ChangedBy",
                        column: x => x.ChangedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobTimelines_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompletionEvidences_BookingId",
                table: "CompletionEvidences",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_JobTimelines_BookingId",
                table: "JobTimelines",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_JobTimelines_ChangedBy",
                table: "JobTimelines",
                column: "ChangedBy");
        }
